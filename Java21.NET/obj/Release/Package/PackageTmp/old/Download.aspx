<%@ Page Title="" Language="C#" MasterPageFile="~/Java.Master" AutoEventWireup="true" CodeBehind="Download.aspx.cs" Inherits="Java21.NET.old.Download" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>APP下载-版本管理</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="ajax" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="gvCategory_PageIndexChanging" CssClass="grid_b" GridLines="None" ShowFooter="True">
                        ...
                        <ItemTemplate>
                            <table style="width: 100%; text-align: center;">
                                <tr>
                                    ...
                                    <td style="width: 20%;"><%# Eval("ver") %></td>
                                    <td style="width: 40%;"><a href='<%# Eval("url") %>' target="_blank"><%# Eval("url") %></a></td>
                                    <td style="width: 20%;"><%# Convert.ToDateTime(Eval("cdate")).ToString("yyyy-MM-dd") %></td>
                                    <td style="width: 10%;">
