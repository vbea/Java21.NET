                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <a href='<%# "KnowledgeView.aspx?id=" + Eval("id") %>' class="jar_a">
                                <table style="width: 100%; text-align: left; word-break:break-all;">
                                    <tr>
                                        <td style=" padding: 2px 5px;"><%# Eval("title") %></td>
                                        <td style="text-align: right; padding-right: 20px; color: gray;">
