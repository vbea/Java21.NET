...
namespace Java21.NET.old
{
    public partial class Articles : System.Web.UI.Page
    {
        ...
        private void getData(int id)
        {
            ...
            txtArticle.Text = row["artical"].ToString();
        ...
        {
            JavaDLL bll = new JavaDLL();
            if (bll.addArticle(txtTitle.Text.Trim(), Convert.ToInt32(ddlCategory.SelectedValue), txtArticle.Text, ((UserInfo)Session["LoginUser"]).UserName))
        ...
        {
            JavaDLL bll = new JavaDLL();
            if (bll.updateArticle(Convert.ToInt32(Request.QueryString["id"]), Convert.ToInt32(ddlCategory.SelectedValue), txtTitle.Text.Trim(), txtArticle.Text, ((UserInfo)Session["LoginUser"]).UserName))
